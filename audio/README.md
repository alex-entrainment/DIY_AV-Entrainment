...
For browser-based projects you can compile the Rust realtime backend to WebAssembly. See [audio/src/realtime_backend/WASM_GUIDE.md](src/realtime_backend/WASM_GUIDE.md) for build and usage steps.
