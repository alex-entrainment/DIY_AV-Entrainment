...
from PyQt5.QtGui import QStandardItemModel, QStandardItem, QIntValidator, QDoubleValidator, QFont, QColor, QPalette
from PyQt5.QtMultimedia import QAudioDeviceInfo, QAudioFormat, QAudioOutput

from ui.voice_editor_dialog import VoiceEditorDialog # Added import

# --- Constants ---
DEFAULT_SAMPLE_RATE = 44100
DEFAULT_CROSSFADE = 1.0
MAX_VOICES_PER_STEP = 100
ENVELOPE_TYPE_NONE = "None" # Keep constants if they are used elsewhere in main.py
